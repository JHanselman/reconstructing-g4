...
f2 := x^2 + 28/5*x*y + 18/5*y^2 - 224/5*z^2 + 102/5*z*w - 33/10*w^2;
f3 := -27/226*x*y^2 - 205/1808*x*z^2 + 15/113*x*z*w - 185/3616*x*w^2 - 39/452*y^3 + y*z^2 - 271/452*y*z*w + 17/452*y*w^2;

// after MinimzeG4
f2 := 10*x^2 + 8*x*y - 9*y^2 - 33*z^2 - 30*z*w - 40*w^2;
f3 := -6*x^3 - 2*x^2*y - x*y^2 + 5*x*z^2 - 22*x*z*w - 5*x*w^2 + 3*y^3 + 11*y*z^2 + 10*y*z*w - 11*y*w^2;
